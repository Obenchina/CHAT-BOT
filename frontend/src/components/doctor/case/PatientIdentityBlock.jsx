            ...
            <div className="card-body">
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 'var(--space-md)' }}>
                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <span style={{ fontSize: '1.1rem', fontWeight: '600', color: 'var(--text-primary)' }}>{patient.first_name || patient.firstName} {patient.last_name || patient.lastName}</span>
                    </div>

                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                        <span style={{ fontSize: '0.8rem', color: 'var(--text-muted)', textTransform: 'uppercase', fontWeight: 'bold' }}>Téléphone</span>
                        <span style={{ fontSize: '1rem', color: 'var(--text-secondary)' }}>{patient.phone || 'Non renseigné'}</span>
                    </div>
