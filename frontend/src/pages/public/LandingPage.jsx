            ...
            <header className="landing-hero">
                ...
                <nav className="landing-topbar">
                    <Link to="/" className="landing-brand">
                        <img src="/assets/logo.png" alt="Med-Bot Logo" className="landing-logo-img" />
                        <span className="landing-brand-text">Med-Bot</span>
                    </Link>
                ...
                <div className="landing-hero-grid">
                    <div className="landing-hero-copy">
                        ...
                        <p className="landing-hero-subtitle">
                            Med-Bot harmonise l'interaction entre l'assistant, le patient et le praticien. 
                    ...
                    <div className="landing-showcase-card">
                        <div className="landing-showcase-head">
                            <div>
                                <span className="landing-showcase-kicker">Écosystème Med-Bot</span>
