/**
 * Doctor Profile Page
 * View and edit doctor profile with professional UI
 */
...
function DoctorProfile() {
    ...
    const getSpecialtyLabel = (value) => {
        const option = SPECIALTY_OPTIONS.find(opt => opt.value === value);
                                    ...
                                    {isEditing ? (
                                        ...
                                        <div className="form-grid">
                                            <div className="info-item">
                                                <div className="info-label">{t.doctor.firstName}</div>
                                                <div className="info-value">{formData.firstName}</div>
                                            </div>
                                            <div className="info-item">
                                                <div className="info-label">{t.doctor.lastName}</div>
                                                <div className="info-value">{formData.lastName}</div>
                                            </div>
                                            <div className="info-item">
                                                <div className="info-label">{t.doctor.gender}</div>
                                                <div className="info-value">{getGenderLabel(formData.gender) || '-'}</div>
                                            </div>
                                            <div className="info-item">
                                                <div className="info-label">{t.doctor.phone}</div>
                                                <div className="info-value">{formData.phone || '-'}</div>
                                            </div>
                                            <div className="info-item">
                                                <div className="info-label">{t.doctor.specialty}</div>
                                                <div className="info-value">{getSpecialtyLabel(formData.specialty)}</div>
                                            </div>
                                            <div className="info-item">
                                            ...
                                            <div className="info-item" style={{ gridColumn: '1 / -1' }}>
                                                <div className="info-label">{t.doctor.address}</div>
