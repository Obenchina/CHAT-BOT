...
function isHallucinatedTranscription(text) {
    ...
    const hallucinationPatterns = [
        ...
        /التخمام، الدوخة، الحمى/i,           // Catch Whisper prompt leakage
        /Diagnostic, fièvre, douleur/i,     // Catch Whisper prompt leakage
        /Le locuteur parle en français/i,   // Catch Whisper prompt leakage
        /Transcription médicale professionnelle/i, // Catch Whisper prompt leakage
        /المتحدث جزائري يتحدث/i             // Catch Whisper prompt leakage
    ];
